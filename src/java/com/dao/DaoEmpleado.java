...
public class DaoEmpleado extends Conexion{
    ...
    public ArrayList<Empleado> listarDb(){
        ...
        try{
            if(this.conectar()){
                sql = "select codigoCarrera, carr.nombre,cantidadU,fac.codigoFacultad, fac.nombre\n" +
                        "as facultad\n" +
                        "from carrera as carr\n" +
                        "inner join facultad as fac on carr.codigoFacultad = fac.codigoFacultad\n" +
